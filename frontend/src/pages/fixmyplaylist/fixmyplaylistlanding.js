	...
	return (
		<>
			...
			<div class="container">
			  ...
			  <InfoCard link={'/c/fixmyplaylist/my-playlists'} icon={<CgMusic style={{width:"100%",height:"100%", transform:"scale(0.6)",opacity:0.7}}/>} title="Your Playlists" subtext="Fix the ordering of your old playlists."/>
			</div>			
		</>
	)
}
